# ✈️ AirplaneAnimation — From Basic OOP to Mach Physics
Evolution from coursework OOP (v1) to modular supersonic simulation (v2) using ISA atmospheric model.

> Original base from "Python OOP Course" by Mark Misin Engineering (Udemy) — Extended to ISA Mach simulation & Manager pattern by Jorge Espino.
> Refactored from course exercise with permission.
